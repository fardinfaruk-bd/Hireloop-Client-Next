          ...
          <Fieldset className="w-full gap-0">
            ...
            <Fieldset.Group className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
              ...
              <Select name="employeeCount" defaultSelectedKeys={[company?.employeeCount || "1-10"]} className="flex flex-col gap-1.5 w-full">
                ...
                <Select.Popover className="bg-[#18181b] border border-[#27272a] rounded-xl shadow-xl text-sm min-w-50">
                  <ListBox>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div 
                  ...
                  className="border border-dashed border-[#3f3f46] rounded-xl p-3 bg-[#212124]/30 hover:bg-[#212124]/60 transition-colors flex items-center gap-4 cursor-pointer min-h-12.5"
                >
